...
/// Happens when a user leaves a channel
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(::serde::Serialize, ::serde::Deserialize))]
pub struct Part<'a> {
    /// The username that left the channel
    pub user: Cow<'a, str>,
    /// The channel the user left
    pub channel: Cow<'a, str>,
}

impl<'a> TryFrom<Message<'a>> for Part<'a> {
...
impl<'a, 'b> TryFrom<&'b Message<'a>> for Part<'a> {
...
mod tests {
    ...
    fn part() {
        let input =
            ":justinfan1234!justinfan1234@justinfan1234.tmi.twitch.tv PART #some_channel\r\n";

        assert_eq!(
            crate::test_util::parse_as::<Part>(input),
            Part {
